...
function getForecast(
    ...
    const st1 = data[0];
    const bt1 = initialTrend(data, period);
    const seasonal = seasonalIndices(data, period, seasons);

    return calcHoltWinters(data, st1, bt1, alpha, beta, gamma, seasonal, period, m);
}
